...
// Prisma output lives in a sibling package (packages/db-catering) rather than this app.
//
// Prisma's runtime engine-locator ALSO always tries "<app>/node_modules/.prisma/client-catering"
...
const src = path.join(__dirname, "..", "..", "packages", "db-catering", "node_modules", ".prisma", "client-catering");
const dest = path.join(__dirname, "..", "node_modules", ".prisma", "client-catering");
