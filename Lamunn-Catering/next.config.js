...
const nextConfig = {
  ...
  transpilePackages: ["@lamunn/db-catering"],
  // @lamunn/db-catering's Prisma client is generated to a non-default name
  // (node_modules/.prisma/client-catering, to avoid colliding with @lamunn/db's
  ...
  experimental: {
    ...
    outputFileTracingIncludes: {
      ...
      // "<app>/node_modules/.prisma/client-catering" automatically — scripts/copy-prisma-engine.js
      ...
      "/**": [
        "../packages/db-catering/node_modules/.prisma/client-catering/**",
        "./node_modules/.prisma/client-catering/**",
      ],
    },
  },
  eslint: {
