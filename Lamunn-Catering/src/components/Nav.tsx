...
const mainLinks = [
  ...
  { href: "/bookings", label: "การจองจัดเลี้ยง", icon: CalendarDays, color: "bg-amber-100 text-amber-600", roles: ALL_ROLES },
  { href: "/pickup-orders", label: "ยอดนัดรับหน้าร้าน", icon: ShoppingBag, color: "bg-emerald-100 text-emerald-500", roles: ALL_ROLES },
  { href: "/customers", label: "ลูกค้า", icon: Users, color: "bg-indigo-100 text-indigo-500", roles: ALL_ROLES },
  { href: "/reports", label: "รายงาน/วิเคราะห์", icon: BarChart3, color: "bg-blue-100 text-blue-500", roles: ALL_ROLES },
];

const otherLinks = [
  { href: "/packages", label: "แพคเกจจัดเลี้ยง", icon: UtensilsCrossed, color: "bg-orange-100 text-orange-500", roles: EDITOR_ROLES },
  { href: "/branches", label: "สาขา/จุดรับของ", icon: Building2, color: "bg-slate-100 text-slate-500", roles: EDITOR_ROLES },
