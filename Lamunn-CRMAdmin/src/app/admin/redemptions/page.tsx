  ...
  return (
    <div>
      <div className="mb-6 flex flex-wrap items-start justify-between gap-3">
        ...
        <Link
          href="/admin/redemptions/history"
          className="flex shrink-0 items-center gap-1.5 rounded-full bg-gray-100 px-3.5 py-2 text-xs font-medium text-gray-600 hover:bg-gray-200"
        >
          <ClipboardList size={14} />
          ประวัติการแลกรางวัลทั้งหมด
        </Link>
      </div>
