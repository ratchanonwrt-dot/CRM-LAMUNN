...
// Prisma output lives in a sibling package (packages/db-live) rather than this app.
//
// Prisma's runtime engine-locator ALSO always tries "<app>/node_modules/.prisma/client-live"
...
const src = path.join(__dirname, "..", "..", "packages", "db-live", "node_modules", ".prisma", "client-live");
const dest = path.join(__dirname, "..", "node_modules", ".prisma", "client-live");
