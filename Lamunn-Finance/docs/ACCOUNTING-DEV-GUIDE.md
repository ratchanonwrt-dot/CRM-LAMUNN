...
ระบบจะตรวจอัตโนมัติว่าไม่แตะหน้าการเงินที่เจ้าของสงวนไว้ (ดูตาราง "ส่วนที่ห้ามแตะ" ใน `AGENTS.md`) และโค้ดคอมไพล์ผ่าน — ผ่านแล้วกด merge เอง เว็บจริงอัปเดตเองภายในไม่กี่นาที
...
2. **ถ้าเครื่องหมายแดง** บอกว่าแตะส่วนที่สงวนไว้ (สถานะการเงินบริษัท / รายงานวิเคราะห์ / ยอดขายรายวัน-รายเดือน / credit term / สถานะเงินสด / ภาพรวม / ค่าใช้จ่ายลงทุน) → ไม่ต้องพยายามแก้ให้ผ่าน ส่งลิงก์ PR ให้เจ้าของระบบดู — ส่วนอื่นทั้งหมดแก้แล้ว merge ได้เอง
...
| PR ตกที่ขั้น accounting-scope | มีไฟล์ในส่วนที่สงวนไว้ถูกแก้ — ให้ Codex `git checkout master -- <ไฟล์นั้น>` เพื่อคืนค่า หรือส่งให้เจ้าของระบบดู |
